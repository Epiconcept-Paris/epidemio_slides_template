...
:::{.callout-important}
Most of the elements we'll discuss today are not reserved to profesionnal coders. They are useful for anyone who writes code, even if it's just for a one-off analysis !
:::
