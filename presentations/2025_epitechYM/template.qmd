...
In a dev perspective, it helps to keep track of the tasks to be done, of the decisions we make, and to prioritize the work.
...
- Automated data quality reports sent to study sites
...
_PS: This presentation has been made with a reproducible workflow using R and quarto. Wants to know more ? Let's talk about it !_