...
_I don't know if they are useful or not, but I feel like I need to read them all to understand the script (and to read all the scripts that are sourced, and all the scripts that are sourced by these sources scripts ...). (James was about to learn very soon one of my mantra : **REMOVE DEAD CODE**)._
